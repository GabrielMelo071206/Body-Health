...
class TestUsuarioRepo:
    ...
    def test_inserir_usuario(self, test_db):
        ...
        id_usuario_db = inserir_usuario(usuario_teste)
        usuario_db = obter_usuario_por_id(id_usuario_db)
        ...
        assert usuario_db.senha_hash == "senha123", "A senha do usuário inserido não confere"
        ...
        assert usuario_db.tipo_usuario == "cliente", "O tipo de usuário inserido não confere"
    ...
    def test_alterar_usuario_existente(self, test_db, usuario_exemplo):
        ...
        usuario_para_alterar = usuario_repo.obter_usuario_por_id(id_inserido)
    ...
    def test_atualizar_senha_existente(self, test_db, usuario_exemplo):
        ...
        resultado = usuario_repo.atualizar_senha_usuario(id_inserido, nova_senha)
        usuario_atualizado_db = usuario_repo.obter_usuario_por_id(id_inserido)
        # Assert
        assert resultado is True
        assert usuario_atualizado_db.senha_hash == nova_senha
    ...
    def test_atualizar_senha_usuario_inexistente(self, test_db):
        ...
        resultado = usuario_repo.atualizar_senha_usuario(id=999, senha_hash="nova_senha")        
...
# Em tests/test_usuario_repo.py
    ...
    def test_excluir_usuario_existente(self, test_db, usuario_exemplo):
        ...
        resultado = usuario_repo.excluir_usuario(id_inserido)
        usuario_excluido = usuario_repo.obter_usuario_por_id(id_inserido)        
